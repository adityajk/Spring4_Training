	...
	<div id="headerSticky">
		<div class="stickyCenter">
			<div class="app-center">
				...
				<div class="top-right">
					<div class="support">
						<a class="btn btn-green btn-login" href="${initParam.resourcePath}/../browseCourses.htm">Browse Courses</a>
					...
					<c:if test="${sessionScope.SPRING_SECURITY_CONTEXT!=null}">
						<a  href="${initParam.resourcePath}/../logout" class="btn btn-green btn-login">Sign Out</a>
					</c:if>
				</div>
			</div>
